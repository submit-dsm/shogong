...
export const _Table = styled.table<{ isScroll?: boolean }>`
  display: flex;
...
export const _TableHead = styled.thead<{ isBorder?: boolean }>`
  position: sticky;
  top: 0;
  left: 0;
  z-index: 1;
...
export const _TableBody = styled.tbody`
  width: 100%;
  max-width: 100%;
`;
 ...
 */
export const _TableCell = styled.td<{
 ...
 */
export const _TableRow = styled.tr<{
  isActive?: boolean;
  isBorder?: boolean;
  isCursor?: boolean;
  customStyle?: boolean;
  ...
  ${({ isActive, theme }) =>
    isActive &&
    css`
      background-color: ${theme.color.main100};
    `}
  ${({ isCursor }) =>
    isCursor &&
    css`
